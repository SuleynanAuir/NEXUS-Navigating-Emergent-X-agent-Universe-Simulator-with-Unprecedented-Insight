<template>
  <div class="process-page">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">NEXUS</div>
...
const handleNewProject = async () => {
  ...
  try {
    ...
    if (pending.focusEntities) {
      formDataObj.append('focus_entities', pending.focusEntities)
    }
    if (pending.focusEvents) {
      formDataObj.append('focus_events', pending.focusEvents)
    }
